            ...
            if ((str.find_first_not_of(" \t\r\n") != string::npos) && (str[0] != '#')) {
                ...
                if (cmd == "light") {
                    if (numused == numLights) { // No more Lights
                        ...
                        if (validinput) {
                            ...
                            int i,j;
                            for (i=0;i<4;i++,j++) lightposn[numused*4+i]=values[i];
                            for (i=4,j=0;i<8,j<4;i++,j++) lightcolor[numused*4+j]=values[i];
                ...
                // Also look at demo.txt to get a sense of why things are done this way.
                    ...
                    if (validinput) {
                        ...
                        mat4 TR;
                        TR=Transform::translate(values[0], values[1], values[2]);
                        rightmultiply(TR, transfstack);
                        mat4 st=transfstack.top();
                        cout<<"TRANSLATE"<<endl;
                        for(int i=0;i<4;i++){
                        cout<<endl;
                            for(int j=0;j<4;j++)
                    ...
                    if (validinput) {
                        ...
                        // Also keep in mind what order your matrix is!
                        mat4 SC;
                        SC=Transform::scale(values[0], values[1], values[2]);
                    ...
                    if (validinput) {
                        ...
                        mat4 R;
                        vec3 raxis;
                        raxis=vec3(values[0],values[1],values[2]);
                        mat3 R1=Transform::rotate(values[3],raxis);
                        R=mat4(R1);
